...
public void updateRoyalties (Connection con)  throws SQLException {
    ...
    String sql = "begin select a.inArtistId, a.vcNameDisplay, a.vcCheckNumber, a.moCheckAmount, a.dtCheck, a.dtCreated, a.dtModified, c.moRoyaltiesPaid, c.moRoyaltiesOwed " +  
            ...
            while (rs.next()) {
                ...
                String sql2 = "begin update tbArtist " +
                              "set moRoyaltiesPaid=( select sum(moCheckAmount) " +
...
// " ELSE update tbArtistRoyalties set moRoyaltiesOwed=0 where inArtistId=? "           
    ...
    public Date getDateCheck() { return this.dateCheck; }
    ...
    public BigDecimal getCheckAmount() {return this.CheckAmount; }
    public BigDecimal getAmtPaid() {
    	if (moPaid==null) { moPaid=new BigDecimal("0.00"); }
	return this.moPaid;
	}
    public String getOrderId() { return this.vcOrderId ; }
    public int getQuantity() { return this.inQty ; }
    public String getItemDesc() { return this.vcItemDesc ; }
    public String getProductVariationId() { return this.vcProductVariationId ; }

    public BigDecimal getAmtOwed() {
    	if (moOwed==null) { moOwed=new BigDecimal("0.00"); }
	return this.moOwed;
	}
    ...
    public static ArrayList getHistory(Connection con, int in) throws SQLException {
        ...
        try {
//            PreparedStatement ps = con.prepareStatement("SELECT * FROM tbArtistRoyalties WHERE inArtistId = ? AND moCheckAmount is not null ORDER BY vcCheckNumber");
            PreparedStatement ps = con.prepareStatement("SELECT a.inId, a.vcNameDisplay, a.vcCheckNumber, a.moCheckAmount, a.dtCheck, a.dtCreated, a.dtModified, b.moRoyaltiesPaid, b.moRoyaltiesOwed from tbArtistRoyalties a, tbArtist b WHERE a.inArtistId=b.inId AND a.inArtistId = ? AND a.moCheckAmount > 0 ORDER BY a.dtCheck DESC");
...
//                Royalties newRoyalties = new Royalties(rs.getInt("vcOrderId"));
    ...
    public void loadFromDb(Connection con) throws SQLException {
        ...
        try {
              PreparedStatement ps = con.prepareStatement("SELECT a.vcNameDisplay, a.vcCheckNumber, a.moCheckAmount, a.dtCheck, a.dtCreated, a.dtModified, b.moRoyaltiesPaid, b.moRoyaltiesOwed from tbArtistRoyalties a, tbArtist b WHERE a.inArtistId=b.inId and inArtistID=?");
//              PreparedStatement ps = con.prepareStatement("SELECT * from tbArtistRoyalties WHERE inArtistID=?");
...
//    public static ArrayList loadRoyaltiesFromDb(Connection con) throws SQLException {
        ...
        try {
            PreparedStatement ps = con.prepareStatement("select sum(moCheckAmount) from tbArtistRoyalties where moCheckAmount is not null and inArtistId=?");
            ps.setInt(1,this.getId());
            ResultSet rs = ps.executeQuery();
            if (rs.next()) {
                loadFromRs(rs);
...
//        }
    ...
    public void setDateCheck(Date in) { this.dateCheck = in; }
    public void setId(int in) { this.id = in; }
    public void setArtistId(int in) { this.ArtistId = in; }
    public void setCheckNumber(String in) { this.CheckNumber = in; }
    public void setNameDisplay(String in) { this.nameDisplay = (in==null) ? "" : in; }
    public void setCheckAmount(BigDecimal in) { this.CheckAmount = in; }
    public void setAmtPaid(BigDecimal in) { this.moPaid = in; }
    public void setAmtOwed(BigDecimal in) { this.moOwed = in; }
    public void setRelationship(String in) { this.relationship = (in==null) ? "" : in; }
    public void setOrderId(String in) { this.vcOrderId = in; }
    public void setQuantity(int in) { this.inQty = in; }
    public void setItemDesc(String in) { this.vcItemDesc = in; }
    public void setProductVariationId(String in) { this.vcProductVariationId = in; }
    public void setDateShipped(Date in) { this.dateShipComplete = in; }
}
